  ...
  return (
    <div className="w-[100%]">
      <div className="w-[90%] md:w-[70%] mx-auto py-24">
        ...
        <h1 className="text-5xl font-extrabold leading-snug">Welcome to Our BD Quick School Gateway to Learning Excellence!</h1>
        {/* Description Admin Profile */}
        <h3 className="py-6 text-xl">
          At BD Quick School we are committed to providing a dynamic and user-friendly platform for your educational journey. Whether you're
          a student, professional, or lifelong learner, our website offers a diverse range of courses to enhance your knowledge and skills.
        </h3>
        {/* Admin Panel Team */}
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 py-10">
          {teams.map((team, idx) => (
            <div className="bg-white p-8 text-center rounded-3xl shadow-2xl" key={idx}>
              <img className="w-[150px] h-[150px] mx-auto rounded-full object-cover" src={team.profile} alt="" />
