  ...
  return (
    <div>
      ...
      <div className=" w-[420px] md:w-[720px] lg:w-[1200px]  mx-auto">
        <h1 className="text-white font-bold mt-10 md:mt-26  mb-10 lg:mb-20  text-center md:text-left text-2xl md:text-3xl lg:text-4xl font-lora ">
          Admission Test Course Details
        </h1>
      </div>
      ...
      <div className="w-[400px] md:w-[720px] lg:w-[1200px]   md:h-[700px] lg:h-[350px]  mx-auto flex flex-col-reverse lg:flex-row justify-between  md:mb-32 lg:mb-40 ">
        <div className=" lg:w-[50%]  text-left md:text-left  md:h-[300px] lg:h-[350px] text-white  ml-5 md:ml-0">
          ...
          <p className="font-medium text-base md:text-base lg:text-base mb-2 font-lora">{detailsAdmission.details}</p>
          <p className="font-medium text-base md:text-base lg:text-xl mt-4 mb-6 font-lora">Course Price : ${detailsAdmission.price}</p>
        </div>

        <div className=" lg:w-[500px] md:h-[300px] lg:h-[350px] mb-6 md:mb-0  ">
          <figure>
            {' '}
            <img className="w-full h-[300px] md:h-[300px] lg:h-[350px] rounded-lg " src={detailsAdmission.image} alt="Shoes" />
          </figure>
        </div>
      </div>
      ...
      <div className="w-[410px] md:w-[720px] lg:w-[1200px]   md:h-[410px]  lg:h-[500px]   md:flex justify-start md:gap-10 lg:gap-20  mx-auto">
        <div className="  ">
          <figure>
            {' '}
            <img
              className="w-[300px] md:w-[300px] h-[200px] md:h-[190px] lg:h-[200px] rounded-lg mx-auto mb-6"
              src={detailsAdmission.teacherImage}
              alt="Shoes"
            />
          </figure>
        </div>
