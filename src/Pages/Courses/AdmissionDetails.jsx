    ...
    return (
        <div>
            ...
            <div className=" w-[420px] md:w-[720px] lg:w-[1200px]  mx-auto">
                <h1 className="text-white font-bold mt-32 mb-20 md:text-3xl lg:text-4xl font-lora ">Admission Test Course Details</h1>

            </div>
           
            <div className="w-[410px] md:w-[720px] lg:w-[1200px]   md:h-[300px] lg:h-[350px]  mx-auto md:flex justify-between items-center mb-32">
        
                <div className=" w-[60%]  md:w-[50%]  text-center md:text-left  md:h-[300px] lg:h-[350px]   text-white ">
                    <h2 className="font-bold md:text-xl lg:text-3xl mb-5 font-lora ">{detailsAdmission.title}</h2>
                    ...
                    <p className="font-medium text-xl md:text-base lg:text-xl mb-6 font-lora">{detailsAdmission.shortdescription}</p>
                    <p className="font-medium text-xl md:text-base lg:text-xl mb-6 font-lora">Course Price : ${detailsAdmission.price}</p>
                    
                </div>

                <div className="md:w-[300px] lg:w-[500px] md:h-[300px] lg:h-[350px]">
            ...
            <div className=" w-[420px] md:w-[720px] lg:w-[1200px]  mx-auto">
                <h1 className="text-white font-bold mt-22 mb-10 text-4xl font-lora">Teacher Details</h1>
            ...
            <div className="w-[420px] md:w-[720px] lg:w-[1200px]   md:h-[410px]  lg:h-[500px]   md:flex justify-start md:gap-10 lg:gap-20  mx-auto">
                ...
                <div className="  ">
                    <figure> <img className="md:w-[300px] h-[300px] md:h-[190px] lg:h-[200px] rounded-lg" src={detailsAdmission.teacherImage} alt="Shoes" /></figure>

                </div>

                <div className=" w-[500px]    text-center md:text-left md:w-[50%] md:h-[px]  lg:h-[500px]   text-white">
                    ...
                    <p className="font-medium text-xl  md:text-base lg:text-xl mb-2 font-lora">{detailsAdmission.graduation}</p>
                    <p className="font-medium text-xl md:text-base lg:text-xl mb-6 font-lora">{detailsAdmission.postgraduation}</p>
