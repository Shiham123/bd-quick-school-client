    ...
    return (
        <div>
            ...
            <div className=" w-[420px] md:w-[720px] lg:w-[1200px]  mx-auto">
                <h1 className="text-white font-bold mt-10 md:mt-26  mb-10 lg:mb-20  text-center md:text-left text-2xl md:text-3xl lg:text-4xl font-lora ">Admission Test Course Details</h1>
