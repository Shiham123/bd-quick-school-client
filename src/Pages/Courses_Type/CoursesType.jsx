            ...
            <div className="flex items-center justify-center gap-24">
                <div className="font-lora flex items-start gap-10">
                    ...
                    <div className="lg:w-[300px] ">
                        ...
                        <button className="px-9 py-3 bg-[#3FA385] text-lg rounded-full text-white uppercase">Start Searching</button>
                    </div>
                </div>
                ...
                <div className="font-lora flex items-start gap-10">
                    ...
                    <div className="lg:w-[300px]">
                        ...
                        <button className="px-9 py-3 bg-[#3FA385] text-lg rounded-full text-white uppercase">Get Premium</button>
                    </div>
                </div>
            </div>
        </div>
