        ...
        <div className="max-w-7xl mx-auto mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 font-lora">
                <div className="w-[350px] md:w-[180px] lg:w-[350px] mx-auto">
                    ...
                    <h2 className="text-2xl md:text-xl lg:text-2xl font-bold text-white text-center mt-4 mb-6">Sign up</h2>
                ...
                <div className="w-[350px] md:w-[180px] lg:w-[350px] mx-auto">
                    ...
                    <h2 className="text-2xl md:text-xl lg:text-2xl font-bold text-white text-center mt-4 mb-6">Select course</h2>
                ...
                <div className="w-[350px] md:w-[180px] lg:w-[350px] mx-auto">
                    ...
                    <h2 className="text-2xl md:text-xl lg:text-2xl font-bold text-white text-center mt-4 mb-6">Start Learning</h2>
