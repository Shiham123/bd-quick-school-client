    ...
    <div className="max-w-7xl mx-auto mb-28">
      ...
      <div className="font-lora grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-5 lg:gap-16 md:ml-3">
        ...
        <div className="flex items-start justify-center md:justify-start gap-4">
          ...
          <div className="w-72 md:w-64 lg:w-72">
            <h3 className="text-white text-xl lg:text-2xl mb-5">{t('WiderangeofCourses')}</h3>
            <p className="text-white lg:text-base">{t('WiderangeofCourses1')}</p>
          </div>
        </div>
        {/* 5th Step */}
        <div className="flex items-start justify-center md:justify-start gap-4">
          ...
          <div className="w-72 md:w-64 lg:w-72">
            <h3 className="text-white text-xl lg:text-2xl mb-5">{t('CommunicativeMethod')}</h3>
            <p className="text-white lg:text-base">{t('CommunicativeMethod1')}</p>
          </div>
        </div>
        {/* 6th Step */}
        <div className="flex items-start justify-center md:justify-start gap-4">
          ...
          <div className="w-72 md:w-64 lg:w-72">
            ...
            <p className="text-white lg:text-base">{t('CentralLocation1')}</p>
          </div>
        </div>
      </div>
